...
import { useStaticsAgeDistributionQuery } from "@/store/queries/statics";
...
const DUMMY_DATA = {
  ...
  bot_answer:
    "<html>    <head>        <title>Báo cáo phân bố độ tuổi</title>        <style>            table {                width: 100%;                border-collapse: collapse;            }            table, th, td {                border: 1px solid black;            }            th, td {                padding: 8px;                text-align: left;            }            th {                background-color: #f2f2f2;            }            tr:nth-child(even) {                background-color: #f9f9f9;            }        </style>    </head>    <body>        <h2>Báo cáo phân bố độ tuổi</h2>        <table>            <tr>                <th>Độ tuổi</th>                <th>Số lượng yêu cầu</th>                <th>Tỷ lệ (%)</th>            </tr>            <tr>                <td>10</td>                <td>9</td>                <td>8.33</td>            </tr>            <tr>                <td>11</td>                <td>6</td>                <td>5.56</td>            </tr>            <tr>                <td>12</td>                <td>5</td>                <td>4.63</td>            </tr>            <tr>                <td>13</td>                <td>8</td>                <td>7.41</td>            </tr>            <tr>                <td>14</td>                <td>1</td>                <td>0.93</td>            </tr>            <tr>                <td>15</td>                <td>8</td>                <td>7.41</td>            </tr>            <tr>                <td>16</td>                <td>6</td>                <td>5.56</td>            </tr>            <tr>                <td>17</td>                <td>4</td>                <td>3.70</td>            </tr>            <tr>                <td>18</td>                <td>7</td>                <td>6.48</td>            </tr>            <tr>                <td>19</td>                <td>1</td>                <td>0.93</td>            </tr>            <tr>                <td>20</td>                <td>4</td>                <td>3.70</td>            </tr>            <tr>                <td>21</td>                <td>5</td>                <td>4.63</td>            </tr>            <tr>                <td>22</td>                <td>4</td>                <td>3.70</td>            </tr>            <tr>                <td>23</td>                <td>5</td>                <td>4.63</td>            </tr>            <tr>                <td>24</td>                <td>6</td>                <td>5.56</td>            </tr>            <tr>                <td>25</td>                <td>7</td>                <td>6.48</td>            </tr>            <tr>                <td>26</td>                <td>6</td>                <td>5.56</td>            </tr>            <tr>                <td>27</td>                <td>5</td>                <td>4.63</td>            </tr>            <tr>                <td>28</td>                <td>6</td>                <td>5.56</td>            </tr>            <tr>                <td>29</td>                <td>7</td>                <td>6.48</td>            </tr>            <tr>                <td>30</td>                <td>6</td>                <td>5.56</td>            </tr>        </table>        <p>Từ bảng phân bố độ tuổi, chúng ta có thể thấy rằng độ tuổi có nhiều yêu cầu nhất là 10 với 9 yêu cầu, chiếm 8.33% tổng số yêu cầu. Tiếp theo là độ tuổi 13 và 15 với 8 yêu cầu, chiếm 7.41%. Các độ tuổi khác dao động từ 1 đến 7 yêu cầu, với tỷ lệ phần trăm tương ứng dao",
};

function aggregateAgeData(data: any) {
  const ageGroups = {
    "10-14": 0,
    "15-19": 0,
    "20-24": 0,
  ...
  data.forEach((item: any) => {
    const age = item.age;
    if (age >= 10 && age <= 14) ageGroups["10-14"] += 1;
    else if (age >= 15 && age <= 19) ageGroups["15-19"] += 1;
    else if (age >= 20 && age <= 24) ageGroups["20-24"] += 1;
    else if (age >= 25 && age <= 29) ageGroups["25-29"] += 1;
    else if (age >= 30 && age <= 34) ageGroups["30-34"] += 1;
  });
...
function AgeTab() {
  ...
  const { sourceData, bot_answer, isFetching } = useStaticsAgeDistributionQuery(
    undefined,
    {
          ...
          <Col span={12}>
            <Doughnut
              ...
              options={{
                plugins: {
                  title: {
                    text: "Tỉ lệ người dùng theo độ tuổi",
                  },
                },
              }}
            />
